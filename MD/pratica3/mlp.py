# encoding: utf-8
"""
Implementação de uma MLP utlizando o scikit-learn.

Original disponível em https://gist.github.com/amueller/2061456
"""
import numpy as np
import warnings
...
class MLPClassifier(BaseMLP, ClassifierMixin):
    ...
    def fit(self, X, y, max_epochs=1000, shuffle_data=False):
