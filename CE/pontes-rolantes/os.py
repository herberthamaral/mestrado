...
OSES = (
    ...
    #(400001,'A','CV01','','','CL03'),
    #(400011,'A','CV02','FPA02','RH01','CL03'),
    #(400021,'B','CV01','FPA01','','CC02'),
    #(400031,'C','CV02','','','CL15'),
    #(400041,'B','CV01','FPA01','','CC02'),
    #(400051,'A','CV02','FPA02','','CC01'),
    #(400061,'B','CV01','FPA01','','CC02'),
    #(400071,'A','CV02','FPA02','','CC01'),
    #(400081,'A','CV01','FPA01','','CC02'),
    #(400091,'A','CV02','FPA02','','CC01'),
    #(400101,'C','CV01','','','CL11'),
    #(400111,'A','CV02','FPA01','','CC02'),
    #(400121,'A','CV01','FPA01','','CC02'),
    #(400131,'A','CV02','FPA02','','CC01'),
    #(400141,'A','CV01','FPA02','','CC01'),
    #(400151,'A','CV02','FPA02','','CC01'),
    #(400161,'A','CV01','FPA02','','CC01'),
    #(400171,'F','CV01','RH01','RH01','CL21'),
    #(400181,'A','CV02','FPA02','RH01','CL03'),
    ...
    #(404391,'A','CV01','FPA02','','CC01'),
    #(404401,'A','CV02','FPA02','','CC01'),
    #(404411,'A','CV01','FPA02','','CC01'),
    #(404421,'F','CV01','RH01','RH01','CL21'),
...
def gera_transicoes_com_pontes_aleatorias():
    ...
    for os in OSES:
        ...
        anterior = os[2]
        if os[3]:
            transicoes.append(dict(origem=anterior, destino=os[3], os=os[:2], ponte=random.choice(('A', 'B'))))
            anterior = os[3]
        if os[4]:
            transicoes.append(dict(origem=anterior, destino=os[4], os=os[:2], ponte=random.choice(('A', 'B', 'C'))))
            anterior = os[4]
        if os[5]:
            transicoes.append(dict(origem=anterior, destino=os[5], os=os[:2], ponte=random.choice(('A', 'B', 'C'))))
            anterior = os[5]
        transicoes.append(dict(origem=anterior, destino=None, os=os[:2], ponte=random.choice(('A', 'B', 'C'))))
